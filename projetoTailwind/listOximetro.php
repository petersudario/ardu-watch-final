...
?>
  <div class="overflow-x-auto relative " style="background-color:rgb(31,41,55);">
   ...
   <a class="font-sans antialiased font-bold text-white" href="./listRtc.php"> <center>Ir para RTC <br></center> </h>
      <a class="font-sans antialiased font-bold text-white" href="./listGps.php"><center> Ir para GPS </center></h>
</div>
